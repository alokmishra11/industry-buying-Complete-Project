...
public class AuthTokenFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            ...
            if (headerAuth != null && jwtUtils.validateJwtToken(headerAuth)) {
                String username = jwtUtils.getUserNameFromJwtToken(headerAuth);
    ...
    public User getUserFromToken(String authToken){
        String phone = jwtUtils.getUserNameFromJwtToken(authToken);
